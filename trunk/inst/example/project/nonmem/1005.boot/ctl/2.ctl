...
$ESTIMATION MAXEVAL=9999 PRINT=5 NOABORT METHOD=1 INTER MSFO=./2.msf
;$COV PRINT=E
;$TABLE NOPRINT FILE=./2.tab ONEHEADER ID AMT TIME EVID PRED IPRE CWRES
;$TABLE NOPRINT FILE=./2par.tab ONEHEADER ID TIME CL Q V2 V3 KA ETA1 ETA2 ETA3
