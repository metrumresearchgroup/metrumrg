...
$COV PRINT=E
$TABLE NOPRINT FILE=./1006.tab ONEHEADER ID AMT TIME EVID PRED IPRE
PRED NPRED CPRED CPREDI EPRED RES NRES NWRES CRES CWRES RESI WRESI CRESI CWRESI ERES EWRES ECWRES
