...
\end{Sinput}
\begin{Soutput}
[1] "queued" "done"   "done"   "queued" "queued"
[1] "compiled" "compiled" "compiled" "compiled" "compiled"
[1] "compiled" "compiled" "compiled" "compiled" "compiled"
[1] "compiled" "compiled" "compiled" "compiled" "compiled"
[1] "compiled" "compiled" "compiled" "compiled" "compiled"
[1] "running" "running" "running" "running" "running"
[1] "running" "running" "running" "running" "running"
[1] "done"    "running" "running" "running" "running"
[1] "done"    "running" "running" "running" "running"
[1] "done"    "running" "running" "done"    "running"
[1] "done"    "running" "running" "done"    "done"   
[1] "done"    "running" "running" "done"    "done"   
[1] "done"    "running" "running" "done"    "done"   
[1] "done"    "done"    "running" "done"    "done"   
...
> Sys.sleep(30) # let all processes complete
\end{Sinput}
\end{Schunk}
...
'data.frame':	275000 obs. of  5 variables:
 ...
 $ PRED: num  0 0.725 1.383 2.067 3.486 ...
...
\end{Sinput}
\begin{Soutput}
1] "Run 285 has exit code 0"
 "Run 116 has exit code 0"
\end{Soutput}
\begin{Sinput}
> length(dir('../nonmem/1005boot'))
\end{Sinput}
\begin{Soutput}
[1] 300
\end{Soutput}
...
> ready <- FALSE
> while (!ready){
+   state <- sapply(run,runstate,project='../nonmem/1005boot')  # infer run progress from file presence/absence
+   print(table(state))
+   if(all(state=='done'))ready <- TRUE     #continue only when runs complete
...
compiled   queued 
      40      260 
state
compiled   queued  running 
      32      260        8 
state
compiled     done   queued  running 
      21        7      260       12 
state
compiled     done   queued  running 
      12       21      253       14 
...
compiled     done   queued  running 
      31       40      221        8 
state
     compiled          done indeterminate        queued       running 
           22            48             1           218            11 
state
compiled     done   queued  running 
      22       58      212        8 
