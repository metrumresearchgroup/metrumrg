...
\begin{table}[!htpb]
 ...
 \begin{center}
  \begin{tabular}{llllll}
   ...
   apparent oral clearance                       & $\mathrm{CL/F  \sim \theta_{1}\cdot  \theta_{6}^{MALE}\cdot (WT/70)^{\theta_{7}}\cdot e^{\eta_{1}}}$ & 9.51 $ L/h $     & 9.84 & (6.19,11)          &  \\
   central volume of distribution                & $\mathrm{V_{c}/F  \sim \theta_{2}\cdot (WT/70)^{1}\cdot e^{\eta_{2}}}$                                  & 22.8 $ L $       & 9.56 & (19.1,26.4)        &  \\
   absorption rate constant                      & $\mathrm{K_{a} \sim \theta_{3}\cdot e^{\eta_{3}}}$                                                       & 0.0714 $ h^-1  $ & 7.35 & (0.0607,0.0801)    &  \\
   intercompartmental clearance                  & $\mathrm{Q/F  \sim \theta_{4}}$                                                                            & 3.47 $ L/h $     & 15.4 & (2.82,5.06)        &  \\
   peripheral volume of distribution             & $\mathrm{V_{p}/F  \sim \theta_{5}}$                                                                        & 113 $ L $        & 21   & (87.9,930)         &  \\
   male effect on clearance                      & $\mathrm{MALE_{CL/F}\sim \theta_{6}}$                                                                      & 1.02 $  $        & 11.2 & (0.86,1.29)        &  \\
   weight effect on clearance                    & $\mathrm{WT_{CL/F}\sim \theta_{7}}$                                                                        & 1.19 $  $        & 28.4 & (0.571,1.87)       &  \\
   interindividual variability of clearance      & $\mathrm{IIV_{CL/F}\sim \Omega_{1.1}}$                                                                     & 0.214 $  $       & 22.8 & (0.132,0.431)      & \%CV = 48.8  \\
   interindividual clearance-volume covariance   & $\mathrm{cov_{CL,V}\sim \Omega_{2.1}}$                                                                     & 0.121 $  $       & 26.4 & (0.0663,0.222)     & CORR = 0.849  \\
