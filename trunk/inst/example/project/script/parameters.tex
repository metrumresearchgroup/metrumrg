...
\begin{table}[!htpb]
 ...
 \begin{center}
  \begin{tabular}{llllll}
   ...
   apparent oral clearance                       & $\mathrm{CL/F  \sim \theta_{1}\cdot  \theta_{6}^{MALE}\cdot (WT/70)^{\theta_{7}}\cdot e^{\eta_{1}}}$ & 9.51 $ L/h $     & 9.84 & (7.31,11.1)       &  \\
   central volume of distribution                & $\mathrm{V_{c}/F  \sim \theta_{2}\cdot (WT/70)^{1}\cdot e^{\eta_{2}}}$                                  & 22.8 $ L $       & 9.56 & (19.2,27.9)       &  \\
   ...
   male effect on clearance                      & $\mathrm{MALE_{CL/F}\sim \theta_{6}}$                                                                      & 1.02 $  $        & 11.2 & (0.847,1.25)      &  \\
   weight effect on clearance                    & $\mathrm{WT_{CL/F}\sim \theta_{7}}$                                                                        & 1.19 $  $        & 28.4 & (0.61,1.91)       &  \\
   ...
   interindividual volume-Ka covariance          & $\mathrm{cov_{V,Ka} \sim \Omega_{3.2}}$                                                                    & -0.0372 $  $     & 36.1 & (-0.0577,-0.0049) & CORR = -0.561 \\
   interindividual variability of Ka             & $\mathrm{IIV_{K_{a}}\sim \Omega_{3.3}}$                                                                    & 0.0466 $  $      & 34.7 & (0.0236,0.0811)   & \%CV = 21.8  \\
